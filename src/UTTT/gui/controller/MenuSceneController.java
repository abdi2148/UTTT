...
import UTTT.dal.DynamicBotClassHandler;
import static UTTT.dal.DynamicBotClassHandler.loadBotList;;
...
public class MenuSceneController implements Initializable {
    ...
    public void clickStart(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader fxLoader = new FXMLLoader(getClass().getResource("/UTTT/gui/view/MainScene.fxml"));
        Parent root = fxLoader.load();

        MainSceneController controller = ((MainSceneController) fxLoader.getController());
